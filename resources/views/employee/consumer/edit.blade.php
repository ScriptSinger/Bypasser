        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{ route('employees-consumer.update', ['employees_consumer' => $consumer->id]) }}">
                        @csrf
                        @method ('PUT')
                        <div class="card-body">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input name="photo" id="photo" type="file" class="custom-file-input @error('photo') is-invalid @enderror">
